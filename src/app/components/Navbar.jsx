        ...
        <>
            ...
            <div className={`fixed top-0 right-0 h-full bg-softBlack text-white w-96 transition-transform duration-300 transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`} aria-hidden={!isOpen}>
                ...
                <ul className="m-8 space-y-1 text-lg">
                    ...
                    <li>
                        <a href="/about" className="block p-3 hover:lightGrey rounded-md">About</a>
                    </li>
                    <li>
                        <a href="/automation" className="block p-3 hover:lightGrey rounded-md">Agency Automation</a>
                    </li>
                    <li>
                        <a href="/pricing" className="block p-3 hover:lightGrey rounded-md"> Pricing</a>
                    </li>
                    <li>
                        <a href="/contact" className="block p-3 hover:lightGrey rounded-md">Contact Us</a>
                    </li>
                </ul>
